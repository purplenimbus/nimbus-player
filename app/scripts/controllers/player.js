	...
	.controller('PlayerCtrl', function ($scope,wave,music,waveForm,genius,artist,$window) {
	  ...
	  //$scope.startTimer($scope.player.songs[index].howler.duration());
		...
		$scope.resetOffCanvas = function(){
			...
			$scope.offCanvas.profile = false;
			$scope.offCanvas.search = false;
		...
		$scope.showProfile = function(){
			...
			$scope.offCanvas.title = $scope.loggedin ? 'account' : 'login';
		
			$scope.offCanvas.profile = true;
